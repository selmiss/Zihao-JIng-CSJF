...
const Network = __importStar(require(".."));
...
describe("Network", () => {
    describe("for arbitrary batches of blocks from an arbitrary set of arbitrarily forked blockchains", () => {
        ...
        let run = 0;
        jest_1.testProp(`saves network genealogies so that @truffle/db correctly reports known latest descendant networks (numRuns: ${testConfig.numRuns})`, [
