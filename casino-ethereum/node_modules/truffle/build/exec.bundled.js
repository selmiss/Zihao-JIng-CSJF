...
const debug = debug_1.default("require:index");
function file(options) {
    var _a;
    const sourceFilePath = path_1.default.resolve(options.file);
    expect_1.options(options, ["file"]);
    ...
    const sandbox = {
        ...
        require: (id) => {
            ...
            if (path_1.default.isAbsolute(id)) {
                debug("absolute", id);
                return original_require_1.default(id);
            }
            ...
            if (id[0] === ".") {
                ...
                return original_require_1.default(modulePath);
            }
            else {
    ...
    process.chdir(cwd);
    const source = typescript_1.compile(conf, sourceFilePath);
...
function exec(options, done) {
    ...
    const interfaceAdapter = interface_adapter_1.createInterfaceAdapter({
...
const debug_1 = __importDefault(__webpack_require__(615158));
const debug = debug_1.default("require:typescript");
...
try {
    ...
    tsNode = original_require_1.default("ts-node");
}
catch (_a) { }
/**
...
function compile(conf, sourceFilePath) {
    const source = fs_1.readFileSync(sourceFilePath, { encoding: "utf-8" });
...
function _compileSandboxGlobalContextTypes(compilationService) {
    ...
    compilationService.compile(fs_1.readFileSync(sandboxGlobalContextTypesPath, { encoding: "utf-8" }), sandboxGlobalContextTypesPath);
}
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [5158,4957,325,5136,5674,6674,8516,406,1324,8716,2765,5358,3983,4866,6793,4877,3833,9826,1669,5898,553,4273,4889], () => (__webpack_require__(241400)))
